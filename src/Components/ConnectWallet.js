    ...
    return (
        <div>
            <div className="container" style={{ display: "flex", justifyContent: "flex-end" }}>
                <button className="button" id="connectButton" onClick={onClickConnect}>
                    <img src={metamask} alt="metamask logo" /> Connect wallet
                    <span id="loading"><span>&bull;</span><span>&bull;</span><span>&bull;</span></span>
                </button>

                <div id="walletID">{Account ? `Wallet connected: ${Account}` : ` Your wallet is not connected yet.`}</div>
